...
cancer_types = ['Pleomorphic carcinoma', 'Adrenal cortical carcinoma', 'Amelanotic melanoma', 'Basaloid squamous cell carcinoma', 'Adenosquamous carcinoma', 'Squamous cell carcinoma, small cell, nonkeratinizing', 'Papillary adenocarcinoma, NOS', 'Superficial spreading melanoma', 'Pheochromocytoma, malignant', 'Mucinous adenocarcinoma, endocervical type', 'Thymoma, type B1, NOS', 'Neuroendocrine carcinoma, NOS', 'Epithelioid mesothelioma, malignant', 'Thymoma, type B2, malignant', 'Medullary carcinoma, NOS', 'Paget disease and infiltrating duct carcinoma of breast', 'Oligodendroglioma, anaplastic', 'Squamous cell carcinoma, keratinizing, NOS', 'Phyllodes tumor, malignant', 'Intraductal micropapillary carcinoma', 'Leiomyosarcoma, NOS', 'Apocrine adenocarcinoma', 'Large cell neuroendocrine carcinoma', 'Papillary serous cystadenocarcinoma', 'Thymoma, type B3, malignant', 'Solid carcinoma, NOS', 'Oligodendroglioma, NOS', 'Mixed epithelioid and spindle cell melanoma', 'Thymoma, type A, NOS', 'Adenocarcinoma with mixed subtypes', 'Renal cell carcinoma, chromophobe type', 'Infiltrating duct mixed with other types of carcinoma', 'Aggressive fibromatosis', 'Papillary carcinoma, NOS', 'Bronchiolo-alveolar carcinoma, non-mucinous', 'Infiltrating duct and lobular carcinoma', 'Pleomorphic liposarcoma', 'Carcinoma, NOS', 'Giant cell sarcoma', 'Cribriform carcinoma, NOS', 'Yolk sac tumor','Abdominal fibromatosis', 'Thymoma, type AB, NOS', 'Dedifferentiated liposarcoma', 'Teratoma, malignant, NOS', 'Signet ring cell carcinoma', 'Pheochromocytoma, NOS', 'Synovial sarcoma, biphasic', 'Fibrous mesothelioma, malignant', 'Papillary squamous cell carcinoma', 'Infiltrating duct carcinoma, NOS', 'Myxoid leiomyosarcoma', 'Epithelioid cell melanoma', 'Endometrioid adenocarcinoma, NOS', 'Cholangiocarcinoma', 'Extra-adrenal paraganglioma, malignant', 'Nonencapsulated sclerosing carcinoma', 'Thymoma, type B1, malignant', 'Papillary carcinoma, columnar cell', 'Extra-adrenal paraganglioma, NOS', 'Paraganglioma, NOS', 'Mixed glioma', 'Mesothelioma, malignant', 'Spindle cell melanoma, NOS', 'Malignant melanoma, NOS', 'Seminoma, NOS', 'Liposarcoma, well differentiated', 'Follicular adenocarcinoma, NOS', 'Follicular carcinoma, minimally invasive', 'Squamous cell carcinoma, large cell, nonkeratinizing, NOS', 'Papillary transitional cell carcinoma', 'Spindle cell melanoma, type B', 'Adenocarcinoma, intestinal type','Squamous cell carcinoma, NOS', 'Acral lentiginous melanoma, malignant', 'Transitional cell carcinoma', 'Papillary carcinoma, follicular variant', 'Bronchio-alveolar carcinoma, mucinous', 'Nodular melanoma', 'Renal cell carcinoma, NOS', 'Teratocarcinoma', 'Astrocytoma, anaplastic', 'Undifferentiated sarcoma', 'Intraductal papillary adenocarcinoma with invasion', 'Bronchiolo-alveolar adenocarcinoma, NOS', 'Acute myeloid leukemia, NOS', 'Thymoma, type A, malignant', 'Tubular adenocarcinoma', 'Serous cystadenocarcinoma, NOS', 'Desmoplastic melanoma, malignant', 'Carcinosarcoma, NOS', 'Thymoma, type B2, NOS', 'Oxyphilic adenocarcinoma', 'Adenocarcinoma, endocervical type', 'Hepatocellular carcinoma, fibrolamellar', 'Adenocarcinoma with neuroendocrine differentiation', 'Mesodermal mixed tumor', 'Mesothelioma, biphasic, malignant', 'Clear cell adenocarcinoma, NOS', 'Astrocytoma, NOS', 'Glioblastoma', 'Adenoid cystic carcinoma', 'Micropapillary carcinoma, NOS', 'Synovial sarcoma, NOS', 'Adenocarcinoma, NOS', 'Infiltrating lobular mixed with other types of carcinoma', 'Embryonal carcinoma, NOS', 'Carcinoma, diffuse type', 'Hepatocellular carcinoma, clear cell type', 'Squamous cell carcinoma, spindle cell', 'Synovial sarcoma, spindle cell', 'Combined hepatocellular carcinoma and cholangiocarcinoma', 'Endometrioid adenocarcinoma, secretory variant', 'Malignant peripheral nerve sheath tumor', 'Thymoma, type AB, malignant', 'Metaplastic carcinoma, NOS', 'Fibromyxosarcoma', 'Thymic carcinoma, NOS', 'Mullerian mixed tumor', 'Teratoma, benign', 'Carcinoma, undifferentiated, NOS', 'Adenocarcinoma in tubolovillous adenoma', 'Paraganglioma, malignant', 'Acinar cell carcinoma', 'Mucinous adenocarcinoma', 'Secretory carcinoma of breast', 'Lentigo maligna melanoma', 'Malignant lymphoma, large B-cell, diffuse, NOS', 'Serous surface papillary carcinoma', 'Basal cell carcinoma, NOS', 'Malignant fibrous histiocytoma', 'Hepatocellular carcinoma, NOS', 'Lobular carcinoma, NOS', 'Mixed germ cell tumor']
